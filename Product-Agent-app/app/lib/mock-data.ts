...
const FRESHCART_ENTITIES: EntityStore = {
  "bo-1": {
    ...
    blocks: [
      { id: "bo-1-b0", type: "metric", metric: "Annual Recurring Revenue", currentValue: "€12M", targetValue: "€14.4M", timeframe: "FY 2026" },
  ...
  "bo-2": {
    ...
    children: ["po-2a"],
    blocks: [
      { id: "bo-2-b0", type: "metric", metric: "New city launches at 10K orders/month", currentValue: "0 new cities", targetValue: "3 cities live", timeframe: "Q4 2026" },
  ...
  "po-1a": {
    ...
    blocks: [
      { id: "po-1a-b0", type: "metric", metric: "Weekly Active Orderers (WAO)", currentValue: "48K", targetValue: "55.2K" },
  ...
  "po-1b": {
    ...
    children: ["opp-3"],
    blocks: [
      { id: "po-1b-b0", type: "metric", metric: "Average Order Value (AOV)", currentValue: "€38", targetValue: "€41.80" },
  ...
  "po-2a": {
    ...
    children: ["opp-4"],
    blocks: [
      { id: "po-2a-b0", type: "metric", metric: "Monthly orders per new city", currentValue: "0 (pre-launch)", targetValue: "10K orders/month" },
...
const INSIGHTPULSE_ENTITIES: EntityStore = {
  "ip-bo-1": {
    ...
    blocks: [
      { id: "ip-bo-1-b0", type: "metric", metric: "Annual Recurring Revenue", currentValue: "$1.2M", targetValue: "$3M", timeframe: "FY 2026" },
  ...
  "ip-bo-2": {
    ...
    children: ["ip-po-2a"],
    blocks: [
      { id: "ip-bo-2-b0", type: "metric", metric: "Monthly logo churn rate", currentValue: "5.2%", targetValue: "<3%", timeframe: "Q3 2026" },
  ...
  "ip-po-1a": {
    ...
    blocks: [
      { id: "ip-po-1a-b0", type: "metric", metric: "14-day trial-to-paid conversion", currentValue: "8%", targetValue: "15%" },
  ...
  "ip-po-1b": {
    ...
    children: ["ip-opp-3"],
    blocks: [
      { id: "ip-po-1b-b0", type: "metric", metric: "Average Contract Value (ACV)", currentValue: "$1,200/yr", targetValue: "$2,000/yr" },
  ...
  "ip-po-2a": {
    ...
    blocks: [
      { id: "ip-po-2a-b0", type: "metric", metric: "90-day paying account retention", currentValue: "72%", targetValue: "88%" },
